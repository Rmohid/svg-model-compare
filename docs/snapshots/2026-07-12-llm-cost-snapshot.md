# LLM Performance vs Cost — 2026-07-12
...
| Premium | Qwen 3.7 Max | 57 | $1.88 | Cheapest way past intel=57; 2.4× cheaper than Gemini 3.1 Pro at the same tier |
| Advanced | Grok 4.5 | 59 | $3.00 (est) | ★ New: cheapest step past Qwen 3.7 Max; knocks Claude Sonnet 5 off the frontier |
| Elite | GPT-5.6 Terra | 60 | $5.63 (est) | ★ New: ties GPT-5.5's intel (60) at half the price ($11.25) |
| Flagship | Claude Opus 4.8 | 61 | $10.00 | Highest intel below the new GPT-5.6/Fable tier |
| Frontier | GPT-5.6 Sol | 64 | $11.25 (est) | ★ New: closes to within 1 point of Claude Fable 5 |
...
- **GPT-5.6 family launches with three tiers:** Sol (intel=64, $11.25 est) lands just 1 point below Claude Fable 5's leaderboard-topping 65; Terra (60, $5.63 est) ties GPT-5.5's intelligence at half the price; Luna (56, $2.25 est) is the budget entrant.
- **Grok 4.5 reshapes the upper frontier:** At intel=59 for $3.00/Mtok (est), it becomes the cheapest step past Qwen 3.7 Max — and, combined with GPT-5.6 Terra, pushes Claude Sonnet 5 (58, $6.00) off the Pareto frontier entirely.
- **Intelligence leaderboard tightens at the top:** Claude Fable 5 still leads at intel=65 (est), but GPT-5.6 Sol now trails by just 1 point — the smallest gap-to-leader since Fable 5 debuted.
- **Speed champion unchanged:** Gemini 3.1 Flash Lite leads at 321 tok/s (intel=34, $0.56/Mtok AA). Among intel≥59 models, Grok 4.5 is fastest at 90 tok/s.
- **Cheapest Pareto step:** DeepSeek V4 Flash at $0.17/Mtok (intel=47) still bests GPT-5.4 Nano ($0.46, intel=44) — 47 vs 44 intel points for less than half the price.
