# LLM Performance vs Cost — 2026-04-27
...
|---|---|---:|---:|---|
| 1 · Budget | Qwen 3.5 9B | 32 | $0.11 | Entry-level priced buy; note Qwen 3.6 Plus offers intel 50 for free on OR |
| 2 · Value | DeepSeek V4 Flash | 47 | $0.17 | +15 intel for $0.06 more; best intel/$ below $1/Mtok |
| 3 · Mid | MiniMax M2.7 | 50 | $0.53 | Best priced intel below $1/Mtok |
| 4 · Upper-mid | Xiaomi MiMo-V2.5-Pro | 54 | $1.50 | Only Chinese model on priced frontier above intel 50 |
| 5 · Premium | Gemini 3.1 Pro | 57 | $4.50 | Enters top-3 intel tier; 130 tok/s |
| 6 · Frontier | GPT-5.5 | 60 | $11.25 | Peak intelligence; GPT-5.5 Pro same score at $67.50 (est) |

**Notable free options:** Qwen 3.6 Plus (intel 50, 53 tok/s) — matches the mid-tier Pareto step at zero OR cost; Ling 2.6 1T (intel 34, 68 tok/s); Ling 2.6 Flash (intel 26, 199 tok/s).

## Highlights

- **Top intelligence:** GPT-5.5 leads at intel 60 ($11.25/Mtok AA). GPT-5.5 Pro matches at the same score but costs $67.50/Mtok (est) — same intelligence tier, 6× the price.
- **Pareto steepest step:** DeepSeek V4 Flash jumps from intel 32 to 47 at just $0.17/Mtok AA blended — the single largest intelligence gain per dollar on the priced frontier below $1.
- **Best free intel:** Qwen 3.6 Plus delivers intel 50 on OpenRouter for free, matching MiniMax M2.7 ($0.53/Mtok) and GLM-5 ($1.55/Mtok) at zero cost.
- **Fastest at intel ≥ 30:** Gemini 3.1 Flash Lite at 321 tok/s with intel 34 and $0.56/Mtok — 28% faster than Gemini 2.5 Flash (250 tok/s) while 36% cheaper on AA blended.
- **Largest AA-vs-OR price divergence:** Gemini 2.5 Flash shows AA blended $0.26 (est) vs OR blended $0.85 — a 3.3× gap, suggesting AA benchmarks a discounted or cached provider tier. Nemotron 3 Super also diverges in the opposite direction: AA $0.41 vs OR $0.20 (AA is 2× OR).
- **Xiaomi on the frontier:** Xiaomi MiMo-V2.5-Pro places at intel 54 for $1.50/Mtok, the only Chinese model reaching the priced Pareto frontier above intel 50; Xiaomi MiMo-V2-Pro has the same intel (49) but lacks an AA price.
