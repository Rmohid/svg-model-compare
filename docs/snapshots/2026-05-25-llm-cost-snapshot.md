# LLM Performance vs Cost — 2026-05-25
...
| Performance | Xiaomi MiMo-V2.5-Pro | 54 | $1.50 | Best performance under $2/Mtok; matches Kimi K2.6 at same price |
| Premium | Gemini 3.1 Pro | 57 | $4.50 | Near top-3 intel at ~$4.50/Mtok; best value in 57-intel tier |
| Top | GPT-5.5 | 60 | $11.25 | Peak intelligence index |

**Notable free options:** **Qwen 3.6 Plus** (intel=50), **Ling 2.6 1T** (intel=34), **Ling 2.6 Flash** (intel=26)

## Highlights

- **Peak intelligence:** GPT-5.5 and GPT-5.5 Pro tie at intel=60. GPT-5.5 at $11.25/Mtok is the economical path to maximum intelligence; GPT-5.5 Pro at $67.50/Mtok (est) is 6× costlier for the same score.
- **Best value under $0.50/Mtok:** DeepSeek V4 Flash (intel=47, $0.17/Mtok AA) delivers near-50 intelligence at an industry-low price — the #2 Pareto step for just $0.06/Mtok above the cheapest model.
- **First sub-$1 model to crack intel 50:** MiniMax M2.7 (intel=50, $0.53/Mtok AA) is the cheapest model hitting the 50-intelligence threshold, matching GLM-5 and Qwen 3.6 Plus while undercutting them on price.
...
- **Best flagship under $5/Mtok:** Gemini 3.1 Pro hits intel=57 (tied with GPT-5.4 and Claude Opus 4.7) at $4.50/Mtok AA, making it the best-value entry in the top-3 intelligence tier.
- **Pricing divergence alert:** Gemini 2.5 Flash shows the largest AA-vs-OR gap — AA prices it at $0.26/Mtok while OpenRouter charges $0.85/Mtok (227% more). Several Meta and NVIDIA models run the other direction: AA benchmarks them above their OR price, suggesting cheaper routing on OR.
