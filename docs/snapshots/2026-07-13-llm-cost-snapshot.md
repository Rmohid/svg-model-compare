# LLM Performance vs Cost — 2026-07-13
...
| Tier | Model | Intel | AA Blended $/Mtok | Notes |
|---|---|---:|---:|---|
| 1 | Gemma 4 31B | 39 | $0.00 | AA measures as free; OR charges $0.21 |
| 2 | DeepSeek V4 Flash | 47 | $0.17 |  |
| 3 | MiniMax M2.7 | 50 | $0.53 |  |
| 4 | Xiaomi MiMo-V2.5-Pro | 54 | $1.50 |  |
| 5 | Qwen 3.7 Max | 57 | $1.88 |  |
| 6 | Grok 4.5 | 59 | $3.00 (est) | AA index estimated |
| 7 | GPT-5.6 Terra | 60 | $5.63 (est) | AA index estimated |
| 8 | Claude Opus 4.8 | 61 | $10.00 |  |
| 9 | GPT-5.6 Sol | 64 | $11.25 (est) | AA index estimated |
| 10 | Claude Fable 5 | 65 | $20.00 (est) | AA index estimated |

**Notable free options:** **Qwen 3.6 Plus** (Intel 50), **Ling 2.6 1T** (Intel 34), **Ling 2.6 Flash** (Intel 26) — all listed as Free on OpenRouter.

## Highlights

- **Top-intel tier**: Claude Fable 5 leads with Intel 65 (AA est), GPT-5.6 Sol is 64 (est); the highest non-estimated entry is Claude Opus 4.8 at Intel 61 for $10.00/Mtok AA.
- **Best value under $2/Mtok (AA)**: Qwen 3.7 Max (Intel 57, $1.88) is the Pareto frontier leader in this band, matching Claude Opus 4.7 and GPT-5.4 at roughly one-fifth their price. Xiaomi MiMo-V2.5-Pro (Intel 54, $1.50) and Kimi K2.6 (Intel 54, $1.71) are Pareto-dominant just below.
- **Sub-$0.20 Pareto winner**: DeepSeek V4 Flash (Intel 47, $0.17 AA) gives the most intelligence under $0.20/Mtok; MiniMax M2.7 (Intel 50, $0.53) is the next frontier rung — a 6-point intel jump for a 3× price increase.
- **Fastest with Intel ≥30**: Gemini 3.1 Flash Lite at 321 tok/s (Intel 34); Gemini 2.5 Flash at 250 tok/s (Intel 30, est); Grok 3 Mini at 207 tok/s (Intel 32) — all sub-$1.50 on OR.
- **Free-tier standout**: Qwen 3.6 Plus (Intel 50, Free on OR) equals MiniMax M2.7 in intelligence at zero cost — best free pick. Ling 2.6 1T (Intel 34) also available free on OR.
- **AA vs OR price divergences >50%**: Gemini 2.5 Flash (AA $0.26 est vs OR $0.85, OR 3× more expensive); Nemotron 3 Super (AA $0.41 vs OR $0.20, OR 51% cheaper); Llama 4 Scout (AA $0.29 vs OR $0.14, OR 52% cheaper); Llama 4 Maverick (AA $0.47 vs OR $0.26, OR 44% cheaper). The AA benchmark uses a specific provider — OR often has cheaper routing. Verify current OR pricing before committing to cost estimates.
