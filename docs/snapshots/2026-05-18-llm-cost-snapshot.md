# LLM Performance vs Cost — 2026-05-18
...
|---|---|---:|---:|---|
| 1 | Gemma 4 31B | 39 | $0.00 | AA benchmark $0; OR $0.21/Mtok |
| 2 | DeepSeek V4 Flash | 47 | $0.17 |  |
| 3 | MiniMax M2.7 | 50 | $0.53 |  |
| 4 | Xiaomi MiMo-V2.5-Pro | 54 | $1.50 |  |
| 5 | Gemini 3.1 Pro | 57 | $4.50 |  |
| 6 | GPT-5.5 | 60 | $11.25 | intelligence ceiling |

**Notable free options:** **Qwen 3.6 Plus** (intel 50, 53 tok/s), **Ling 2.6 1T** (intel 34, 68 tok/s), **Ling 2.6 Flash** (intel 26, 199 tok/s).

## Highlights

- **Top intelligence (index 60):** **GPT-5.5** ($11.25/Mtok) and **GPT-5.5 Pro** ($67.50/Mtok est) share the top spot. GPT-5.5 is the far better value at $11.25/Mtok; GPT-5.5 Pro's $67.50/Mtok is an AA estimate.
- **Best-value frontier below $1/Mtok:** **MiniMax M2.7** (intel 50) at $0.53/Mtok — the highest intelligence achievable on the Pareto curve for under $1/Mtok.
- **Cheapest path to intel 57:** **Gemini 3.1 Pro** at $4.50/Mtok (AA) matches GPT-5.4, Claude Opus 4.7 on intelligence at a meaningfully lower cost.
- **Fastest at intel ≥ 30:** **Gemini 3.1 Flash Lite** at 321 tok/s (intel 34, $0.56/Mtok AA) — 1.3× the throughput of the second-fastest qualifying model (Gemini 2.5 Flash at 250 tok/s).
- **Highest efficiency on the frontier below $1/Mtok:** **DeepSeek V4 Flash** (intel 47 / $0.17/Mtok = 276 intel-index points per $/Mtok) — the steepest rise on the Pareto curve.
- **Largest AA/OR price divergence:** **Gemini 2.5 Flash** — AA blended $0.26 vs OR blended $0.85 (69% gap). The AA entry is flagged `(est)` — it uses historical numbers predating the current OR listing.
