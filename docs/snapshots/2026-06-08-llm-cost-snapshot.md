# LLM Performance vs Cost — 2026-06-08

Snapshot of 46 LLMs comparing **Intelligence Index** (Artificial Analysis composite, higher is better), **blended price** (USD per million tokens, weighted 3·input + 1·output / 4), and **output speed** (tokens/sec). Data sourced from `INTEL_DATA` in `generate.py`. Underlying AA snapshot date: `2026-05-31`.

## Pareto best-value frontier

| Tier | Model | Intel | Blended $/Mtok | Notes |
|---|---|---:|---:|---|
| Entry | Qwen 3.5 9B | 32 | $0.11 | Cheapest priced model on frontier |
| Budget | DeepSeek V4 Flash | 47 | $0.17 | +15 intel for $0.06/Mtok more |
| Mid | MiniMax M2.7 | 50 | $0.53 | First sub-$1 model to reach intel 50 |
| Performance | Xiaomi MiMo-V2.5-Pro | 54 | $1.50 | Best value under $2/Mtok; Kimi K2.6 matches at $1.71 |
| Premium | Qwen 3.7 Max | 57 | $1.88 | Top-tier intel at <$2/Mtok — new entrant displaces Gemini 3.1 Pro ($4.50) |
| Top | Claude Opus 4.8 | 61 | $10.00 | New peak intelligence; beats prior leader GPT-5.5 (60) |

**Notable free options:** **Qwen 3.6 Plus** (intel=50), **Ling 2.6 1T** (intel=34), **Ling 2.6 Flash** (intel=26)

## Highlights

- **New peak intelligence**: Claude Opus 4.8 enters at intel=61, dethroning GPT-5.5 (60) as the top-scored model. Both sit near $10–$11/Mtok; GPT-5.5 Pro ties at 60 for an estimated $67.50/Mtok.
- **Best value at intel=57**: Four models share the 57-tier. New entrant Qwen 3.7 Max achieves it at $1.88/Mtok — 2.4× cheaper than Gemini 3.1 Pro ($4.50), 3× cheaper than GPT-5.4 ($5.63), and 5.3× cheaper than Claude Opus 4.7 ($10.00). Qwen 3.7 Max displaces Gemini 3.1 Pro from the Pareto Premium slot.
- **Speed leader (intel ≥ 30)**: Gemini 3.1 Flash Lite leads at 321 tok/s with intel=34 at $0.56/Mtok. Grok 3 Mini (207 tok/s, intel=32, $0.35/Mtok) and new entry Qwen 3.7 Max (189 tok/s, intel=57) offer strong speed-plus-intelligence combinations.
- **Best Pareto value under $1/Mtok**: DeepSeek V4 Flash hits intel=47 at $0.17/Mtok (frontier step 2); MiniMax M2.7 steps to intel=50 at $0.53/Mtok (step 3). GPT-5.4 Nano at $0.46/Mtok gets intel=44 but doesn't clear the frontier.
- **Pricing divergence (>50% AA vs OR gap)**: Gemini 2.5 Flash (AA $0.26 est vs OR $0.85 — OR is 227% more); Llama 4 Scout (AA $0.29 vs OR $0.14 — AA is 115% above OR); Nemotron 3 Super (AA $0.41 vs OR $0.20 — AA is 105% above OR); Llama 4 Maverick (79%), Qwen 3.5 35B (55%), Qwen 3.5 122B (54%).
- **Best free option**: Qwen 3.6 Plus at intel=50 leads the free tier — on par with MiniMax M2.7 ($0.53/Mtok) and GLM-5 ($1.55/Mtok) at the same intel=50 mark.
