# LLM Performance vs Cost — 2026-06-22
...
|---|---|---:|---:|---|
| Entry | Qwen 3.5 9B | 32 | $0.11 | Cheapest priced entry on the frontier |
| Budget | DeepSeek V4 Flash | 47 | $0.17 | +15 intel for $0.06/Mtok more |
| Value | MiniMax M2.7 | 50 | $0.53 | Cheapest route to Intel 50 |
| Balanced | Xiaomi MiMo-V2.5-Pro | 54 | $1.50 | Best intel under $2/Mtok |
| Premium ★ | Qwen 3.7 Max | 57 | $1.88 | NEW: 2.4× cheaper than prior premium (Gemini 3.1 Pro at $4.50) |
| Top ★ | Claude Opus 4.8 | 61 | $10.00 | NEW: highest intel in dataset; beats GPT-5.5 (60) by one point |

**Notable free options:** **Qwen 3.6 Plus** (intel=50), **Ling 2.6 1T** (intel=34), **Ling 2.6 Flash** (intel=26)

## Highlights

- **New top-tier model:** Claude Opus 4.8 enters the dataset at Intel=61, claiming #1 overall ahead of GPT-5.5 (Intel=60) — both cost $10–11/Mtok, but Anthropic now has the intelligence edge.
- **Pareto frontier reshuffled at the 57-intel tier:** Qwen 3.7 Max (Intel=57, $1.88/Mtok) displaces Gemini 3.1 Pro ($4.50/Mtok) as the best-value path to near-top intelligence — same score at 2.4× lower cost. Gemini 3.5 Flash (new at Intel=55, $3.38/Mtok) fills the gap just below.
- **Best value under $1/Mtok:** MiniMax M2.7 (Intel=50, $0.53/Mtok) holds the Pareto crown in this tier, matching GLM-5 (Intel=50, $1.55/Mtok) at less than a third of the price.
- **Speed champion (Intel ≥ 30):** Gemini 3.1 Flash Lite leads at 321 tok/s (Intel=34, $0.56/Mtok). New entrant Gemini 3.5 Flash (176 tok/s, Intel=55) is the fastest model at Intel ≥ 55.
- **Price divergences >50%:** Gemini 2.5 Flash shows AA=$0.26/Mtok (est, historical) vs. OR=$0.85/Mtok — OR is 3.3× more. Meta's Llama models run the opposite direction: Llama 4 Scout is $0.29 AA vs. $0.14 OR (115% gap); Llama 4 Maverick is $0.47 AA vs. $0.26 OR (79% gap); Nemotron 3 Super is $0.41 AA vs. $0.20 OR (105% gap).
- **Free tier standout:** Qwen 3.6 Plus (Intel=50) matches paid models at $0 on OpenRouter; its AA blended ($1.13/Mtok) reflects the cost on AA's benchmark provider. Three models total hit Intel ≥ 26 for free on OR (also Ling 2.6 1T at Intel=34 and Ling 2.6 Flash at Intel=26).
