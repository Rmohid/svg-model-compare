# LLM Performance vs Cost — 2026-05-11
...
|---|---|---:|---:|---|
| 1 | Qwen 3.5 9B | 32 | $0.11 | Budget entry point |
| 2 | DeepSeek V4 Flash | 47 | $0.17 | Biggest intel jump per dollar |
| 3 | MiniMax M2.7 | 50 | $0.53 | Best mid-tier value |
| 4 | Xiaomi MiMo-V2.5-Pro | 54 | $1.50 | Premium efficiency |
| 5 | Gemini 3.1 Pro | 57 | $4.50 | Near-flagship, Google |
| 6 | GPT-5.5 | 60 | $11.25 | Peak intelligence |

**Notable free options:** **Qwen 3.6 Plus** (intel 50), **Ling 2.6 1T** (intel 34), **Ling 2.6 Flash** (intel 26)

## Highlights

- **Top tier** (60 intel): GPT-5.5 and GPT-5.5 Pro lead the leaderboard; GPT-5.5 is available at $11.25/Mtok (AA) while GPT-5.5 Pro carries an estimated $67.50/Mtok tag for the "xhigh" context tier.
- **Best sub-$1 Pareto pick**: DeepSeek V4 Flash reaches intel 47 at $0.17/Mtok (AA) — the steepest intelligence-per-dollar step on the frontier, jumping 15 points from the $0.11 baseline.
- **Speed leader at intel ≥ 30**: Gemini 3.1 Flash Lite outputs 321 tok/s with intel 34, making it the fastest option among competent models.
- **Best intel-per-dollar under $1**: Qwen 3.5 9B yields 291 intel-pts/dollar at $0.11/Mtok — the top value on the Pareto frontier below the $1 mark.
- **Largest AA/OR price divergence**: Llama 4 Scout — AA lists it at $0.29 vs OR's $0.14 — OR has a cheaper provider available.
- **Free at intel 50**: Qwen 3.6 Plus is available at no cost on OpenRouter (intel 50, 53 tok/s), rivalling paid mid-tier models.
